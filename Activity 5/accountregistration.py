...
class MyWindow:
    def __init__(self, win):
        ...
        self.win = win
        self.lbl1 = Label(self.win, text="New Account Registration", fg="#000000", font=("Arial", 20), bg='#ADD8E6')
        self.lbl1.place(x=65, y=10)
        self.lbl2 = Label(self.win, text="First Name", fg="#000000", bg='#ADD8E6')
        self.lbl2.place(x=40, y=50)
        self.entry1 = Entry(self.win, width=35, fg="#000000", bg='#B19CD9')
        self.entry1.place(x=145, y=50)
        self.lbl3 = Label(self.win, text="Last Name", fg="#000000", bg='#ADD8E6')
        self.lbl3.place(x=40, y=80)
        self.entry2 = Entry(self.win, width=35, fg="#000000", bg='#B19CD9')
        self.entry2.place(x=145, y=80)
        self.lbl4 = Label(self.win, text="Username", fg="#000000", bg='#ADD8E6')
        self.lbl4.place(x=40, y=110)
        self.entry3 = Entry(self.win, width=35, fg="#000000", bg='#B19CD9')
        self.entry3.place(x=145, y=110)
        self.lbl5 = Label(self.win, text="Password", fg="#000000", bg='#ADD8E6')
        self.lbl5.place(x=40, y=140)
        self.entry4 = Entry(self.win, show="*", width=35, fg="#000000", bg='#B19CD9')
        self.entry4.place(x=145, y=140)
        self.lbl6 = Label(self.win, text="Email Address", fg="#000000", bg='#ADD8E6')
        self.lbl6.place(x=40, y=170)
        self.entry5 = Entry(self.win, width=35, fg="#000000", bg='#B19CD9')
        self.entry5.place(x=145, y=170)
        self.lbl7 = Label(self.win, text="Contact Number", fg="#000000", bg='#ADD8E6')
        self.lbl7.place(x=40, y=200)
        self.entry6 = Entry(self.win, width=35, fg="#000000", bg='#B19CD9')
        self.entry6.place(x=145, y=200)
        self.btn1 = Button(self.win, text="Submit", fg="#000000", command=self.submit, bg='#FFFFED')
        self.btn1.place(x=100, y=240)
        self.btn2 = Button(self.win, text="Clear", fg="#000000", command=self.clear, bg='#FFFFED')
